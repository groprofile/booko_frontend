...
export default function AdminSidebar({ collapsed, onToggle }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Logo */}
      <div className="relative flex h-14 items-center border-b border-[#1E2D45] px-4">
        {!collapsed && (
        ...
        {collapsed && (
          <div className="cta-gradient flex h-7 w-7 items-center justify-center rounded-lg text-white text-xs font-extrabold">
            B
          </div>
        )}
        <button
