...
export default function BokkoExpertWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-4 z-50 sm:bottom-6 sm:right-6 xl:hidden">
      {open && (
        <div className="mb-3 w-[280px] rounded-[20px] border border-[#E2E8F0] bg-white p-5 shadow-[0_20px_50px_rgba(15,23,42,0.15)]">
          ...
          <p className="mt-2 text-sm font-bold text-[#0F172A]">Need help choosing a workspace?</p>
