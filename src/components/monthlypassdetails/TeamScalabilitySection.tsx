...
export default function TeamScalabilitySection({ seatTiers }: TeamScalabilitySectionProps) {
  ...
  return (
    <section className="rounded-sm border border-[#E2E8F0] bg-white p-6">
      ...
      <div className="mt-4 flex flex-col gap-3 rounded-sm bg-[#F8FAFC] p-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
        ...
        {requested ? (
          <span className="rounded-sm bg-[#ECFDF5] px-4 py-2.5 text-sm font-semibold text-[#16A34A]">
          ...
          <button
            ...
            className="cta-gradient flex h-11 items-center justify-center rounded-sm px-5 text-sm font-bold text-white"
          >
