...
export default function BusinessSolutionsSection({ citySlug }: BusinessSolutionsSectionProps) {
  ...
  const solutions = [
    { icon: Building2, title: "Virtual Office", description: "Browse more virtual offices in this city.", href: `/${citySlug}/virtual-office` },
    { icon: Briefcase, title: "Meeting Room", description: "Book an hourly meeting room nearby.", href: `/${citySlug}/meeting-rooms` },
    { icon: Armchair, title: "Coworking Day Pass", description: "Get a day pass at a coworking space.", href: `/${citySlug}/day-pass` },
  ...
  return (
    <section>
      ...
      <p className="mb-4 text-sm text-[#64748B]">
        Everything your business needs, all bookable on Bokko.
      </p>
