        ...
        <div className="rounded-2xl border border-[#E2E8F0] bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              ...
              className="w-full rounded-xl bg-[#2563EB] py-3.5 text-sm font-bold text-white shadow-sm transition-all hover:bg-[#1d4ed8]"
            >
            ...
            <a
              ...
              className="w-full rounded-xl border border-[#E2E8F0] py-3 text-center text-sm font-semibold text-[#334155] transition-colors hover:bg-[#F8FAFC]"
            >
              Open Email App
            </a>
            ...
            <button
              ...
              disabled={cooldown > 0}
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#E2E8F0] py-3 text-sm font-medium text-[#64748B] transition-colors hover:bg-[#F8FAFC] disabled:opacity-50"
            >
